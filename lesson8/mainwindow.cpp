...
void MainWindow::textDateAndTime()
{
    QDateTime time = QDateTime::currentDateTime();
    QString str = time.toString ("yyyy-MM-dd hh: mm: ss");
        activeMdiChild()->insertPlainText(str);
}
...
void MainWindow::setupTextActions()
{
    ...
    actionFigureWindow->setShortcut(Qt::CTRL + Qt::Key_J);
    actionFigureWindow->setCheckable(true);
    actionFigureWindow->setPriority(QAction::LowPriority);
    tb->addAction(actionFigureWindow);

    const QIcon checkboxIconData = QIcon::fromTheme("isert-date-and-time", QIcon(":/file/icon/calendar.png"));
    actionDateAndTime = menu->addAction(checkboxIconData, tr("Chec&ked"), this, &MainWindow::textDateAndTime);
    actionDateAndTime->setShortcut(Qt::CTRL + Qt::Key_T);
    actionDateAndTime->setCheckable(true);
    actionDateAndTime->setPriority(QAction::LowPriority);
    tb->addAction(actionDateAndTime);
